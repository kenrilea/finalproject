   ...
   render = () => {
      ...
      return (
         <div className="lobbies-list-elem-container">
            ...
            <button className="pure-material-button-contained green square bottom-pad big-button-font" disabled={this.props.playerTwo ? true : false} onClick={this.props.playerTwo ? undefined : () => this.joinLobby(this.props.lobbyId)} >
